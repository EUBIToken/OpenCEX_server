...
define("OpenCEX_dataset_version", 5);
...
abstract class OpenCEX_L2_context{
	...
	public function destroy_active_session(){
		...
		setcookie("OpenCEX_session", "", 1, "", $this->safe_getenv("OpenCEX_host"), getenv("OpenCEX_secure") === "true", true);
	}
...
final class OpenCEX_L3_context extends OpenCEX_L2_context {
	...
	public function session_create(int $userid, bool $persistent = false){
		...
		$this->check_safety(setcookie("OpenCEX_session", base64_encode($session_token), $expiry, "", $this->safe_getenv("OpenCEX_host"), getenv("OpenCEX_secure") === "true", true), "Unable to set session cookie!");
	}
